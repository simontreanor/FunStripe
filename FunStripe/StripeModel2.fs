...
module StripeModel =
    ...
    and AccountBrandingSettings = {
        ...
        Icon: Choice<string,File> option
        ///(ID of a [file upload](https://stripe.com/docs/guides/file-upload)) A logo for the account that will be used in Checkout instead of the icon and without the account's name next to it if provided. Must be at least 128px x 128px.
        Logo: Choice<string,File> option
    ...
    and AlipayAccount = {
        ...
        Customer: Choice<string,Customer,DeletedCustomer> option
    ...
    and ApplicationFee = {
        ...
        BalanceTransaction: Choice<string,BalanceTransaction> option
        ///ID of the charge that the application fee was taken from.
        Charge: Choice<string,Charge>
        ///Time at which the object was created. Measured in seconds since the Unix epoch.
        Created: int64
        ...
        OriginatingTransaction: Choice<string,Charge> option
    ...
    and BalanceTransaction = {
        ...
        Source: Choice<string,BalanceTransactionSource> option
    ...
    and BankAccount = {
        ...
        Account: Choice<string,Account> option
    ...
    and Card = {
        ...
        Recipient: Choice<string,Recipient> option
    ...
    and Charge = {
        ...
        Application: Choice<string,Application> option
        ///The application fee (if any) for the charge. [See the Connect documentation](https://stripe.com/docs/connect/direct-charges#collecting-fees) for details.
        ApplicationFee: Choice<string,ApplicationFee> option
        ...
        Destination: Choice<string,Account> option
        ///Details about the dispute if the charge has been disputed.
        Dispute: Choice<string,Dispute> option
        ...
        Invoice: Choice<string,Invoice> option
        ...
        OnBehalfOf: Choice<string,Account> option
        ///ID of the order this charge is for if one exists.
        Order: Choice<string,Order> option
        ///Details about whether the payment was accepted, and why. See [understanding declines](https://stripe.com/docs/declines) for details.
        Outcome: ChargeOutcome option
        ///`true` if the charge succeeded, or was successfully authorized for later capture.
        Paid: bool
        ///ID of the PaymentIntent associated with this charge, if one exists.
        PaymentIntent: Choice<string,PaymentIntent> option
        ...
        Transfer: Choice<string,Transfer> option
    ...
    and ChargeOutcome = {
        ...
        Rule: Choice<string,Rule> option
    ...
    and ChargeTransferData = {
        ...
        Amount: int64 option
        ///ID of an existing, connected Stripe account to transfer funds to if `transfer_data` was specified in the charge request.
        Destination: Choice<string,Account>
    }
    ...
    ///You can use this value to decide when to fulfill your customer's order.
        ...
        SetupIntent: Choice<string,SetupIntent> option
    ...
    and CreditNote = {
        ...
        Currency: string
        ///ID of the customer.
        Customer: Choice<string,Customer,DeletedCustomer>
        ///Customer balance transaction related to this credit note.
        CustomerBalanceTransaction: Choice<string,CustomerBalanceTransaction> option
        ...
        Refund: Choice<string,Refund> option
    ...
    ///If you are using payment methods created via the PaymentMethods API, see the [invoice_settings.default_payment_method](https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method) field instead.
        DefaultSource: Choice<string,PaymentSource> option
    ...
    and CustomerBalanceTransaction = {
        ...
        CreditNote: Choice<string,CreditNote> option
        ///Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
        Currency: string
        ///The ID of the customer the transaction belongs to.
        Customer: Choice<string,Customer>
        ///An arbitrary string attached to the object. Often useful for displaying to users.
        Description: string option
    ...
    and DeletedDiscount = {
        ...
        PromotionCode: Choice<string,PromotionCode> option
    ...
    and DiscountsResourceDiscountAmount = {
        ...
        Discount: Choice<string,Discount,DeletedDiscount>
    }
    ...
    and DisputeEvidence = {
        ...
        CancellationPolicy: Choice<string,File> option
        ...
        CustomerCommunication: Choice<string,File> option
        ...
        CustomerSignature: Choice<string,File> option
        ///(ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Documentation for the prior charge that can uniquely identify the charge, such as a receipt, shipping label, work order, etc. This document should be paired with a similar document from the disputed payment that proves the two payments are separate.
        DuplicateChargeDocumentation: Choice<string,File> option
        ...
        Receipt: Choice<string,File> option
        ///(ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Your refund policy, as shown to the customer.
        RefundPolicy: Choice<string,File> option
        ...
        ServiceDocumentation: Choice<string,File> option
        ...
        ShippingDocumentation: Choice<string,File> option
        ///The tracking number for a physical product, obtained from the delivery service. If multiple tracking numbers were generated for this purchase, please separate them with commas.
        ShippingTrackingNumber: string option
        ///(ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Any additional evidence or statements.
        UncategorizedFile: Choice<string,File> option
    ...
    and FeeRefund = {
        ...
        Fee: Choice<string,ApplicationFee>
        ///Unique identifier for the object.
        Id: string
        ///Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
        Metadata: Map<string, string> option
    ...
    and Invoice = {
        ...
        AccountTaxIds: Choice<string,TaxId,DeletedTaxId> list option
        ...
        Charge: Choice<string,Charge> option
        ...
        DefaultPaymentMethod: Choice<string,PaymentMethod> option
        ...
        Discounts: Choice<string,Discount,DeletedDiscount> list option
    ...
    and Invoiceitem = {
        ...
        Discounts: Choice<string,Discount> list option
        ///Unique identifier for the object.
        Id: string
    ...
    and IssuingAuthorization = {
        ...
        Cardholder: Choice<string,IssuingCardholder> option
        ///Time at which the object was created. Measured in seconds since the Unix epoch.
        Created: int64
        ///Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
        Currency: string
    ...
    and IssuingCard = {
        ...
        ReplacedBy: Choice<string,IssuingCard> option
        ///The card this card replaces, if any.
        ReplacementFor: Choice<string,IssuingCard> option
    ...
    and IssuingDispute = {
        ...
        Transaction: Choice<string,IssuingTransaction>
    }
    with
        ///String representing the object's type. Objects of the same type share the same value.
    ...
    and IssuingTransaction = {
        ...
        Authorization: Choice<string,IssuingAuthorization> option
        ///ID of the [balance transaction](https://stripe.com/docs/api/balance_transactions) associated with this transaction.
        BalanceTransaction: Choice<string,BalanceTransaction> option
        ///The card used to make this transaction.
        Card: Choice<string,IssuingCard>
        ...
        Dispute: Choice<string,IssuingDispute> option
        ///Unique identifier for the object.
        Id: string
        ///Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode.
        Livemode: bool
    ...
    and IssuingCardholderIdDocument = {
        ...
        Back: Choice<string,File> option
        ///The front of a document returned by a [file upload](https://stripe.com/docs/api#create_file) with a `purpose` value of `identity_document`.
        Front: Choice<string,File> option
    }
    ...
    and IssuingDisputeCanceledEvidence = {
        ...
        AdditionalDocumentation: Choice<string,File> option
    ...
    and IssuingDisputeDuplicateEvidence = {
        ...
        CardStatement: Choice<string,File> option
        ///(ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Copy of the receipt showing that the product had been paid for in cash.
        CashReceipt: Choice<string,File> option
        ///(ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Image of the front and back of the check that was used to pay for the product.
        CheckImage: Choice<string,File> option
        ///Explanation of why the cardholder is disputing this transaction.
        Explanation: string option
    ...
    and Mandate = {
        ...
        PaymentMethod: Choice<string,PaymentMethod>
    ...
    and OrderItem = {
        ...
        Parent: Choice<string,Sku> option
    ...
    ///If present in combination with [setup_future_usage](https://stripe.com/docs/api#payment_intent_object-setup_future_usage), this PaymentIntent's payment method will be attached to the Customer after the PaymentIntent has been confirmed and any required actions from the user are complete.
        ...
        PaymentMethod: Choice<string,PaymentMethod> option
    ...
    ///When processing card payments, Stripe also uses `setup_future_usage` to dynamically optimize your payment flow and comply with regional legislation and network rules, such as [SCA](https://stripe.com/docs/strong-customer-authentication).
        ...
        Source: Choice<string,PaymentSource,DeletedPaymentSource> option
    ...
    and PaymentMethod = {
        ...
        Customer: Choice<string,Customer> option
    ...
    and PaymentMethodDetailsBancontact = {
        ...
        GeneratedSepaDebit: Choice<string,PaymentMethod> option
        ///The mandate for the SEPA Direct Debit PaymentMethod which was generated by this Charge.
        GeneratedSepaDebitMandate: Choice<string,Mandate> option
    ...
    and Payout = {
        ...
        Destination: Choice<string,ExternalAccount,DeletedExternalAccount> option
        ///If the payout failed or was canceled, this will be the ID of the balance transaction that reversed the initial balance transaction, and puts the funds from the failed payout back in your balance.
        FailureBalanceTransaction: Choice<string,BalanceTransaction> option
        ...
        OriginalPayout: Choice<string,Payout> option
        ///If the payout was reversed, this is the ID of the payout that reverses this payout.
        ReversedBy: Choice<string,Payout> option
    ...
    and Plan = {
        ...
        Product: Choice<string,Product,DeletedProduct> option
    ...
    and Price = {
        ...
        Product: Choice<string,Product,DeletedProduct>
    ...
    and Recipient = {
        ...
        DefaultCard: Choice<string,Card> option
        ///An arbitrary string attached to the object. Often useful for displaying to users.
        Description: string option
        Email: string option
        ///Unique identifier for the object.
        ...
        MigratedTo: Choice<string,Account> option
        ///Full, legal name of the recipient.
        Name: string option
        RolledBackFrom: Choice<string,Account> option
    ...
    and Refund = {
        ...
        SourceTransferReversal: Choice<string,TransferReversal> option
        ...
        TransferReversal: Choice<string,TransferReversal> option
    }
    with
        ///String representing the object's type. Objects of the same type share the same value.
    ...
    and SepaDebitGeneratedFrom = {
        ...
        SetupAttempt: Choice<string,SetupAttempt> option
    }
    ...
    and SetupAttempt = {
        ...
        SetupIntent: Choice<string,SetupIntent>
    ...
    ///If present, the SetupIntent's payment method will be attached to the Customer on successful setup. Payment methods attached to other Customers cannot be used with this SetupIntent.
        ...
        LatestAttempt: Choice<string,SetupAttempt> option
        ///Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode.
        Livemode: bool
        ///ID of the multi use Mandate generated by the SetupIntent.
        Mandate: Choice<string,Mandate> option
        ///Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
        Metadata: Map<string, string> option
        ...
        SingleUseMandate: Choice<string,Mandate> option
    ...
    and Subscription = {
        ...
        LatestInvoice: Choice<string,Invoice> option
        ///Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode.
        Livemode: bool
        ///Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
        Metadata: Map<string, string>
        ...
        PendingSetupIntent: Choice<string,SetupIntent> option
        ///If specified, [pending updates](https://stripe.com/docs/billing/subscriptions/pending-updates) that will be applied to the subscription once the `latest_invoice` has been paid.
        PendingUpdate: SubscriptionsResourcePendingUpdate option
        ///The schedule attached to the subscription
        Schedule: Choice<string,SubscriptionSchedule> option
    ...
    and SubscriptionScheduleAddInvoiceItem = {
        ...
        Price: Choice<string,Price,DeletedPrice>
    ...
    and SubscriptionScheduleConfigurationItem = {
        ...
        Plan: Choice<string,Plan,DeletedPlan>
    ...
    and SubscriptionSchedulePhaseConfiguration = {
        ...
        Coupon: Choice<string,Coupon,DeletedCoupon> option
    ...
    and Transfer = {
        ...
        DestinationPayment: Choice<string,Charge> option
        ///Unique identifier for the object.
        Id: string
        ///Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode.
        Livemode: bool
        ...
        SourceTransaction: Choice<string,Charge> option
    ...
    and TransferReversal = {
        ...
        DestinationPaymentRefund: Choice<string,Refund> option
        ///Unique identifier for the object.
        Id: string
        ///Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
        Metadata: Map<string, string> option
        ///ID of the refund responsible for the transfer reversal.
        SourceRefund: Choice<string,Refund> option
        ///ID of the transfer that was reversed.
        Transfer: Choice<string,Transfer>
    }
    with
        ///String representing the object's type. Objects of the same type share the same value.
