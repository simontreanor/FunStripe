...
module Subscriptions =
    ...
    type Create'InvoiceSettings with
        static member New(?accountTaxIds: Choice<string list,string>, ?customFields: Choice<Create'InvoiceSettingsCustomFields list,string>, ?description: string, ?footer: string, ?issuer: Create'InvoiceSettingsIssuer) =
            {
    ...
    type Update'InvoiceSettings with
        static member New(?accountTaxIds: Choice<string list,string>, ?customFields: Choice<Update'InvoiceSettingsCustomFields list,string>, ?description: Choice<string,string>, ?footer: Choice<string,string>, ?issuer: Update'InvoiceSettingsIssuer) =
            {
                AccountTaxIds = accountTaxIds
                CustomFields = customFields
                Description = description
